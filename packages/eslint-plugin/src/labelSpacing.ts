...
export const labelSpacing: Rule.RuleModule = {
  meta: {
    ...
    docs: {
      description:
        "Ensure spacing above and below Label statements with a simple block of labels",
      recommended: false,
    },
    schema: [],
    messages: {
      spacing:
        "Label statement with a block of labels must have a blank line above and below.",
    },
  },
  create(context) {
